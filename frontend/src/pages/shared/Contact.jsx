      ...
      <div className={s.mainContainer}>
        <div className={s.header}>
          ...
          <p className={s.subheading}>
            Have questions or feedback, we would love to hear from you. Our team
          ...
          <div className={s.contactInfoContainer}>
            <div className={s.contactInfoCard}>
              ...
              <div className={s.contactItem}>
                ...
                <div>
                  ...
                  <div className={s.contactDetail}>+1 (555) 000-1234</div>
                </div>
              </div>
            </div>
            ...
            <div className={s.quickSupportCard}>
              ...
              <p className={s.quickSupportText}>
                Available 24 to 7 for our premium members your satisfaction is
                our priority over here
              </p>
            </div>
          </div>
